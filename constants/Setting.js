const Setting = {
    ...
    termsAndConditions: `
        ...
        The parties of this License Agreement acknowledge that Apple is not a Party to this License Agreement and is not bound by any provisions or obligations with regard to the Application, such as warranty, liability, maintenance and support thereof. Daily Bear, not Apple, is solely responsible for the licensed Application and the content thereof.
        
        This License Agreement may not provide for usage rules for the Application that are in conflict with the latest App Store Terms of Service. Daily Bear acknowledges that it had the opportunity to review said terms and this License Agreement is not conflicting with them.
        ...
        Daily Bear (hereinafter: Application) is a piece of software created to Emotion Diary for everyday via cell phone - and customized for Apple mobile devices. It is used to To write a Diary everyday and keep your emotion.
        ...
        2.3  You may not share or make the Application available to third parties (unless to the degree allowed by the Apple Terms and Conditions, and with Daily Bear's prior written consent), sell, rent, lend, lease or otherwise redistribute the Application.
        
        2.4  You may not reverse engineer, translate, disassemble, integrate, decompile, integrate, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Application, or any part thereof (except with Daily Bear's prior written consent).
        ...
        3.1  The Application requires relatively latest OS version equal or higher than IOS 12.0. Licensor recommends using the latest version of the firmware.
        ...
        4.2  Daily Bear and the End-User acknowledge that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the licensed Application.
        ...
        9.2  No warranty is provided for the Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of Daily Bear's sphere of influence that affect the executability of the Application.
        
        9.3  You are required to inspect the Application immediately after installing it and notify Daily Bear about issues discovered without delay by e-mail provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been mailed within a period of sixty (60) days after discovery.
        
        9.4  If we confirm that the Application is defective, Daily Bear reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
        ...
        Daily Bear and the End-User acknowledge that Daily Bear, and not Apple, is responsible for addressing any claims of the End-User or any third party relating to the licensed Application or the End-User’s possession and/or use of that licensed Application, including, but not limited to:
        ...
        Dongeun Kim, Geonsang Yoo
        strawchoo@naver.com, geonsangyoo@gmail.com
        
        
        13. TERMINATION
        
        The license is valid until terminated by Daily Bear or by You. Your rights under this license will terminate automatically and without notice from Daily Bear if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Application, and destroy all copies, full or partial, of the Application.
        
        
        14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY
        
        Daily Bear represents and warrants that Daily Bear will comply with applicable third-party terms of agreement when using licensed Application.
        ...
        Daily Bear and the End-User acknowledge that, in the event of any third-party claim that the licensed Application or the End-User's possession and use of that licensed Application infringes on the third party's intellectual property rights, Daily Bear, and not Apple, will be solely responsible for the investigation, defense, settlement and discharge or any such intellectual property infringement claims.
        
        
        16. APPLICABLE LAW
        
        This license agreement is governed by the laws of South Korea excluding its conflicts of law rules.
