...
const DiaryDetail = (props) => {
  ...
  if (
    ...
    props.route.params?.emotion !== undefined
  ) {
    diary.emotion = props.route.params?.emotion;
  }
  const dateString =
  ...
  return (
    <KeyboardAvoidingView
      ...
      <Background
        style={{
          ...styles.container,
          opacity: isCancelModalOpened ? Diary.opacity : 1,
        }}>
        ...
        <RectangleBox style={styles.rectangleBoxCloseModalContainer}>
          ...
          <View style={styles.cancelModalContainer}>
            <Text
              ...
              style={{
                ...styles.cancelModalButtonTextStyle,
                fontFamily: fontNameSetting
                  ? fontNameSetting
                  : SettingConstants.defaultFont,
              }}>
